...
def poster_grid(cards, cols=6, key_prefix="grid"):
    ...
    for r in range(rows):
        ...
        for c in range(cols):
            ...
            with colset[c]:
                if poster:
                    st.image(poster, width=180)   # or 200 / 220 depending on layout
                else:
...
# ==========================================================
    ...
    with left:
        ...
        if data.get("poster_url"):
            st.image(data["poster_url"], width=200)   # or 200 / 220 depending on layout
    ...
    if data.get("backdrop_url"):
        ...
        st.image(data["backdrop_url"], width=180)   # or 200 / 220 depending on layout
